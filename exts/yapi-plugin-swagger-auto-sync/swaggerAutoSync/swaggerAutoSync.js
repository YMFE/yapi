      ...
      <div className="m-panel">
        <Form>
          ...
          <div>
            ...
            <FormItem {...formItemLayout} label="swagger json url">
            ...
            >
              {getFieldDecorator('sync_cron', {
                ...
                initialValue: this.state.sync_data.sync_cron
                  ? this.state.sync_data.sync_cron
                  : this.state.random_corn,
              })(<Input />)}
            </FormItem>
          </div>
